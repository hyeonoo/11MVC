...
<div class="container">
		...
		<div class="page-header">
	       ...
	       <h5 class="text-muted">현재 <strong class="text-danger">등록</strong>하신 상품정보입니다.</h5>
	    </div>
		...
		<div class="form-group">
		 	 ...
		 	 <a  href="#" class="btn btn-primary btn-lg active" role="button"> 확&nbsp;인</a>
		 	 <a href="#"  class="btn btn-default btn-lg active" role="button">추가&nbsp;등록</a>
		 </div>
